...
python test/test_k_mean_datasets.py --dataset trivia_qa --freetest --chunk_size 1024 --n_clusters 779 --k_clusters_list 8 15 23 30 35 40 --k_chunks_list 2 2 2 2 2 2
